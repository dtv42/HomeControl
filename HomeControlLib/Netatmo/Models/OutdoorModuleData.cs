// --------------------------------------------------------------------------------------------------------------------
// <copyright file="OutdoorModuleData.cs" company="DTV-Online">
...
{
    public class OutdoorModuleData : ModuleData
    {
        #region Public Properties

        public OutdoorModuleDashboard DashboardData { get; set; } = new OutdoorModuleDashboard();
