...
namespace FroniusWeb
{
    ...
    public class Startup : BaseStartupWeb<AppSettings>
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<IFronius, Fronius>();
            services.AddSingleton<Microsoft.Extensions.Hosting.IHostedService, FroniusMonitor>();

            // Adding SignalR support.
            services.AddSignalR();

            // Adds support for HTTP client and sets up policies.
            services.AddHttpClient<IFroniusClient, FroniusClient>(client =>
            {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            {
                routes.MapHub<FroniusHub>("/hubs/monitor");
            });
