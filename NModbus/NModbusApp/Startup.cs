...
namespace NModbusApp
{
    ...
    public class Startup : BaseStartup<AppSettings>, IStartup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<ITcpClient, TcpClient>(client => new TcpClient()
            {
                TcpMaster = _settings.TcpMaster,
                TcpSlave = _settings.TcpSlave
            });
            services.AddSingleton<IRtuClient, RtuClient>(client => new RtuClient()
            {
                RtuMaster = _settings.RtuMaster,
                RtuSlave = _settings.RtuSlave
            });
