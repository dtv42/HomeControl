...
namespace NModbusApp.Commands
{
    ...
    public class TcpMonitorCommand : BaseCommand<AppSettings>
    {
        ...
        /// </summary>
        /// <param name="client">The _client.client instance.</param>
        /// <param name="logger">The logger instance.</param>
        /// <param name="options">The setting options instance.</param>
        /// <param name="environment">The hosting environment instance.</param>
        public TcpMonitorCommand(ITcpClient client,
                                 ILogger<TcpMonitorCommand> logger,
                                 IOptions<AppSettings> options,
                                 IHostingEnvironment environment)
            : base(logger, options, environment)
        {
            _logger.LogDebug("TcpMonitorCommand()");
        ...
        public async Task<int> OnExecute(CommandLineApplication app)
        {
            ...
            {
                _logger.LogError(ex, $"TcpMonitorCommand - {ex.Message}");
                return -1;
            }
            finally
            {
