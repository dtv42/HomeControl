...
namespace BControlApp.Commands
{
    ...
    /// </summary>
    [Command(Name = "BControlApp",
             FullName = "BControl Application",
    ...
    public class RootCommand : BaseCommand<AppSettings>
    {
        ...
        public RootCommand(IBControl bcontrol,
        ...
        public int OnExecute(CommandLineApplication app)
        {
            ...
            try
            {
                if (CheckOptions(app))
                {
                    ...
                    _bcontrol.TcpSlave.Address = Address;
                    _bcontrol.TcpSlave.Port = Port;
                    _bcontrol.TcpSlave.ID = SlaveID;

                    if (_bcontrol.Connect())
                    {
