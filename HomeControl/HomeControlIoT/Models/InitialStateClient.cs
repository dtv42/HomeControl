// --------------------------------------------------------------------------------------------------------------------
// <copyright file="InitialStateClient.cs" company="DTV-Online">
...
namespace HomeControlIoT.Models
{
    ...
    internal class InitialStateClient : BaseClass, IInitialStateClient
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InitialStateClient"/> class.
        /// </summary>
        /// <param name="client"></param>
        /// <param name="logger"></param>
        public InitialStateClient(HttpClient client,
                                  ILogger<InitialStateClient> logger) : base(logger)
        {
            _client = client;
        ...
        public async Task<HttpResponseMessage> PostAsync(string request, StringContent content)
