...
namespace EM300LRLib.Models
{
    ...
    /// </summary>
    public class Phase1Data : DataValue, IPropertyHelper
    {
        ...
        public static string[] GetProperties()
            => typeof(Phase1Data).GetProperties(BindingFlags.Instance | BindingFlags.Public | BindingFlags.DeclaredOnly)
        ...
        public static bool IsProperty(string property) => PropertyValue.GetPropertyInfo(typeof(Phase1Data), property) != null;
        ...
        public static PropertyInfo GetPropertyInfo(string property) => PropertyValue.GetPropertyInfo(typeof(Phase1Data), property);
