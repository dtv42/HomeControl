...
namespace NetatmoWeb
{
    ...
    public class Startup : BaseStartupWeb<AppSettings>
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<INetatmo, Netatmo>();
            services.AddSingleton<Microsoft.Extensions.Hosting.IHostedService, NetatmoMonitor>();
            ...
            services.AddHttpClient<INetatmoClient, NetatmoClient>(client =>
            {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            {
                routes.MapHub<NetatmoHub>("/hubs/monitor");
            });
