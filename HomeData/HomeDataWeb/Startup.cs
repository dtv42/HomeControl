...
namespace HomeDataWeb
{
    ...
    public class Startup : BaseStartupWeb<AppSettings>
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddHttpClient<IHomeDataClient1, HomeDataClient1>(client =>
            {
                client.BaseAddress = new Uri(_settings.Meter1Address);
            ...
            {
                client.BaseAddress = new Uri(_settings.Meter2Address);
                client.Timeout = TimeSpan.FromSeconds(_settings.Timeout);
            }).ConfigureHttpMessageHandlerBuilder(config => new HttpClientHandler
            {
                ServerCertificateCustomValidationCallback = (message, cert, chain, errors) => { return true; }
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            {
                routes.MapHub<HomeDataHub>("/hubs/monitor");
            });
