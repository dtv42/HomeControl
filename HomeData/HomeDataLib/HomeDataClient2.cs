namespace HomeDataLib
{
    ...
    public class HomeDataClient2 : BaseClass, IHomeDataClient2
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="HomeDataClient1"/> class.
        /// </summary>
        /// <param name="client"></param>
        /// <param name="logger"></param>
        public HomeDataClient2(HttpClient client,
                              ILogger<HomeDataClient2> logger) : base(logger)
        {
            _client = client;
