...
namespace SYMO823MWeb.Services
{
    ...
    public abstract class TimedService : BaseService<AppSettings>, IHostedService, IDisposable
    {
        ...
        public Task StartAsync(CancellationToken cancellationToken)
        {
            ...
            _update = new Timer(OnUpdateElapsed, null, _settings.UpdatePeriod, _settings.UpdatePeriod);
        ...
        public Task StopAsync(CancellationToken cancellationToken)
        {
            ...
            _update?.Change(Timeout.Infinite, 0);
            return Task.CompletedTask;
        }
        ...
        /// <summary>
        /// The update timer callback method.
        /// </summary>
        /// <param name="state">The timer callback state object.</param>
        public async void OnUpdateElapsed(object state)
        {
            _logger?.LogDebug($"TimedService update timer elapsed.");
            await DoUpdateAsync();
        }
        ...
        /// Derived classes should override this.
        /// </summary>
        protected virtual async Task DoUpdateAsync()
            => await Task.Delay(1);
