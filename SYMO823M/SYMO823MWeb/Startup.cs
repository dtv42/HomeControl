...
namespace SYMO823MWeb
{
    ...
    public class Startup : BaseStartupWeb<AppSettings>
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                TcpMaster = _settings.Master,
                TcpSlave = _settings.Slave
            });
            services.AddSingleton<ISYMO823M, SYMO823M>();
            services.AddSingleton<Microsoft.Extensions.Hosting.IHostedService, SYMO823MMonitor>();
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            {
                routes.MapHub<SYMO823MHub>("/hubs/monitor");
            });
